...
<link href=<?=Illuminate\Support\Facades\URL::asset('assets/css/fSelect.css') ?> rel="stylesheet">
                            ...
                            <div class="ibox-content">
                                ...
                                <form role="form" class="form-horizontal m-t">
                                    ...
                                    <div class="form-group draggable">
                                     ...
                                     <div class="form-group draggable">
                                        <label class="col-sm-3 control-label">下拉多选框：</label>
                                        <div class="col-sm-9">
                                           <select class="form-control"  id = 'demo' multiple="multiple">
 ...
 <script type="text/javascript" src=<?=Illuminate\Support\Facades\URL::asset('assets/js/jquery-ui-1.10.4.min.js') ?> ></script>
 <script type="text/javascript" src=<?=Illuminate\Support\Facades\URL::asset('assets/js/beautifyhtml.js') ?> ></script>
  <script type="text/javascript" src=<?=Illuminate\Support\Facades\URL::asset('assets/js/fSelect.js') ?> ></script>
